...
void fadein (WAVE wave, int n)
{
   ...
   {
      printf ("Fade in cannot be longer than wave\n");
      exit (EXIT_FAILURE);
   }

   for (i = 0; i < samplestofade; i++)
   {
      volume = (double) i / (double) samplestofade;
